...
## Agent 1. Profile & Balance Agent (The "Character Assigner")
...
## Agent 2. Finance Planner Agent (The "FOMO Negotiator" & "Enforcer")
...
UPDATE: REMOVE OVERSPENT CARD LIKE WTF IS THIS??
---

## Agent 3. Conversational Tabung Builder (The "Goal Architect") OFF
...
## Agent 4. Receipt Scanner Agent (The "Automation Engine")
...
---
## Agent 5. Macro-Market Sentinel (The "Inflasi" Watchdog)
