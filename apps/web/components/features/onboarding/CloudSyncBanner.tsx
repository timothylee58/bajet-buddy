...
import { Cloud, AlertTriangle, X, ArrowRight } from "lucide-react";
...
export function CloudSyncBanner() {
  ...
  useEffect(() => {
    if (isGuest && guestData.xp >= 100) {
      const dismissed = sessionStorage.getItem("bb_sync_dismissed");
      if (!dismissed) {
        setIsVisible(true);
      }
    }
  }, [isGuest, guestData.xp]);
  ...
  const handleSync = () => {
    router.push("/register?sync=true");
  };
          ...
          <div className="p-4 flex gap-4 items-start">
            ...
            <div className="flex-1 space-y-1">
              ...
              <p className="text-xs text-amber-800 leading-tight">
                ...
                If you clear your browser, your {guestData.persona?.name || "stats"} and {guestData.transactions.length} transactions will vanish forever.
              </p>
